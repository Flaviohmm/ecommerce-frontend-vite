        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-950 dark:to-blue-950 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Seu carrinho está vazio</h2>
                    <p className="text-gray-600 dark:text-gray-400 mb-6">Adicione alguns produtos para continuar</p>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200">Carrinho de Compras</h1>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-lg p-6 sticky top-4">
                                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-4">Resumo de Pedido</h3>
